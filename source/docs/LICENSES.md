...
`assets/lily.png`, `assets/flower-nursery.png`, `assets/jack-shop.png` созданы встроенным imagegen для этого проекта без входных изображений. PNG уменьшены для быстрой загрузки браузерной версии.
